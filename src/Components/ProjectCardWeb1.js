...
const ProjectCardWeb1 = ({ appLink, codeLink, projectTitle, projectYear, projectDescription, projectScreenshots, skill1, skill2, bgImageProject }) => {
...
export default ProjectCardWeb1;
